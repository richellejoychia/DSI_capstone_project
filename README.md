...
2. Part 2 of the data (e.g., images, duration, and description) was scraped from TripAdvisor using Selenium. The images and duration were scraped to showcase on Streamlit. As for the description, it was partially used to create the labels based on a Hugging Face model. This was not included in Streamlit as I only wanted to show information that would capture people's attention instantly.
